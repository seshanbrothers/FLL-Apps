...
if (language == 'es') {
  ...
  menuApp.controller("MenuCtrl", function($scope) {
    ...
    $scope.Yes = 'Si';
    $scope.No = 'No';
    $scope.Title = 'Marcador Animal Allies';
  ...
  menuApp.controller("MenuCtrl", function($scope) {
    ...
    $scope.Yes = 'Ja';
    $scope.No = 'Nein';
    $scope.Title = 'Animal Allies Punkterechner';
  ...
  menuApp.controller("MenuCtrl", function($scope) {
    ...
    $scope.Yes = 'Sim';
    $scope.No = 'Não';
    $scope.Title = 'Pontuador do Animal Allies';
  ...
  menuApp.controller("MenuCtrl", function($scope) {
    ...
    $scope.Yes = 'Ja';
    $scope.No = 'Nee';
    $scope.Title = 'Animal Allies Puntenteller';
  ...
  menuApp.controller("MenuCtrl", function($scope) {
    ...
    $scope.Yes = 'Yes';
    $scope.No = 'No';
    $scope.Title = 'Animal Allies Scorer';
    $scope.Scorer = 'Scorer';
    $scope.Timers = 'Timers';
    $scope.Saves = 'Saves';
    $scope.Points = 'Points';
